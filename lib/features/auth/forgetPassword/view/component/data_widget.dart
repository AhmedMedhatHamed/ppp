              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  enabledBorder: OutlineInputBorder(
                    borderSide: const BorderSide(color: Color(0xFF3e3121)),
                ...
                try {
                  ...
                  showDialog(
                    ...
                    builder: (context) {
                      return AlertDialog(
                        ...
                        content: const Text('Your password reset has been sent to your email'),
                        actions: <Widget>[
                          TextButton(
                            onPressed: () {
                              Navigator.of(context).pop();
                  ...
                  showDialog(
                    ...
                    builder: (context) {
                      return AlertDialog(
                        title: const Text('Error'),
                        content: const Text('An error occurred. Please enter a valid email'),
                        actions: <Widget>[
                          TextButton(
                            onPressed: () {
                              Navigator.of(context).pop();
